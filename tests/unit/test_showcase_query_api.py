...
def test_query_surface_helpers_cover_mode_names_source_counts_and_segments() -> None:
    db = _FakeDb()
    hits = [SimpleNamespace(vector_id="mutable-1"), SimpleNamespace(vector_id="sealed-1")]
