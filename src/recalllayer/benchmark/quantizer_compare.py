...
class QuantizerComparisonArtifacts:
    rows: list[ComparisonRow]


def run_quantizer_comparison(root_prefix: str = ".quantizer_compare") -> QuantizerComparisonArtifacts:
    ...
    return QuantizerComparisonArtifacts(rows=rows)
