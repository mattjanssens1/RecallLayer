...
def main() -> None:
    ...
    markdown_path = reports_dir / "quantizer_comparison_diagnostics.md"
    ...
    diagnostics = BenchmarkDiagnostics(
        ...
        top_k=2,
        report_kind="quantizer-comparison",
    )
    diagnostics_path = write_diagnostics(diagnostics, reports_dir / "quantizer_comparison_diagnostics.json")
    print(markdown_path)
